...
const char * decode_charset_iconv(const char *str) {
  const int charset = MeCabJp::decode_charset(str);
  switch (charset) {
    case MeCabJp::UTF8:
      return "UTF-8";
    case MeCabJp::EUC_JP:
    ...
    case  MeCabJp::UTF16:
      return "UTF-16";
    case  MeCabJp::UTF16LE:
      return "UTF-16LE";
    case  MeCabJp::UTF16BE:
      return "UTF-16BE";
    default:
      std::cerr << "charset " << str
                << " is not defined, use " MECAB_JP_DEFAULT_CHARSET;
      return MECAB_JP_DEFAULT_CHARSET;
  }
  return MECAB_JP_DEFAULT_CHARSET;
}
#endif
