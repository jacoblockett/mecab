...
#ifndef MECAB_JP_COMMON_H_
#define MECAB_JP_COMMON_H_
...
#ifdef MECAB_JP_USE_UTF8_ONLY
#define MECAB_JP_DEFAULT_CHARSET "UTF-8"
#endif

#ifndef MECAB_JP_DEFAULT_CHARSET
#if defined(_WIN32) && !defined(__CYGWIN__)
#define MECAB_JP_DEFAULT_CHARSET "SHIFT-JIS"
#else
#define MECAB_JP_DEFAULT_CHARSET "EUC-JP"
#endif
#endif
...
// WPATH_FORCE was undefined for MSVC on Windows
#ifdef _WIN32
#ifdef __GNUC__
#define WPATH_FORCE(path) (MeCabJp::Utf8ToWide(path).c_str())
#define WPATH(path) (path)
#else
#define WPATH_FORCE(path) (MeCabJp::Utf8ToWide(path).c_str())  // <-- ADD THIS LINE
